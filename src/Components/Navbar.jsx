...
const Navbar = () => {
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-cyan-400'>
        <div className='flex '>
            <img className='w-10 h-10 m-2 cursor-pointer rounded-full brightness-150' src={logo} alt="Nexus-logo" />
            <h1 className='text-5xl font-bold text-cyan-400 hover:shadow-cyan-400'>NEXUS</h1>
        </div>
        <ul className='hidden md:flex items-center gap-28 font-medium mr-82'>
            <NavLink to='/'>
            ...
            <NavLink to='/about'>
                <li className='py-1 text-white  hover:text-cyan-400'>ABOUT</li>
                <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden' /> 
            </NavLink>
        </ul>
